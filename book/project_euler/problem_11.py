...
# ## Getting the Data
#
# First, let's convert the text to a friendly data structure.
...
#
# Next, let's write an iterator that will traverse the grid
# the way we want to.


# %%
def adjacent(grid: np.ndarray, n: int) -> np.ndarray:
