...
simulation.velocity.plot(hue="ax")
plt.show()
...
simulation.position.plot(hue="ax")
plt.show()
...
# %%
pos_above_z_0 = simulation.position.where(simulation.position.sel(ax="z") < 0)
simulation = simulation.where(pos_above_z_0, drop=True)
...
simulation_interp.position.plot(hue="ax")
plt.show()
...
# %%
simulation_interp.velocity.plot(hue="ax")
